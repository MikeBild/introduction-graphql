...
export default WrappedComponent => {
  return class WithGraphQL extends React.Component {
    static displayName = `WithGraphQL(${getComponentDisplayName(WrappedComponent)})`

    static async getInitialProps (ctx) {
      let serverState = {}

      let composedInitialProps = {}
      if (WrappedComponent.getInitialProps) composedInitialProps = await WrappedComponent.getInitialProps(ctx)
