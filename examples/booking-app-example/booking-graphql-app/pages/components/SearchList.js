        ...
        <SearchListContainer>
          <div>
            <label>
              ...
              Search by location <LocationsList />
            </label>
            <br />
            <SearchInput
              type="search"
          ...
          {!search.trip && (
            <StartTripButton onClick={() => createTrip()}>
              Start a Trip
            </StartTripButton>
          )}
          {search.trip &&
            ...
            search.trip.car &&
            search.trip.car.id && <BookTrip trip={search.trip} />}
        </SearchListContainer>
        <hr />
        <div className={className}>
          {search.search &&
            search.search.map((x, i) => (
              <Search key={i} {...x} trip={search.trip} />
            ))}
        </div>
      </div>
    );
...
const RootQuery = gql`
  query Search($location: String, $id: ID) {
